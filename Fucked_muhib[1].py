...
[1;91m -->  [1;92mFACEBOOK   :          /its.muhib.7
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
			...
			sys.stdout.write('\r \33[1;92m[MUHIB-143] [%s] \33[1;92m[OK:\33[1;92m%s\33[1;92m]'%(loop,len(oks))),
			sys.stdout.flush()
